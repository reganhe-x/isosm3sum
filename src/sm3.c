...
static uint32_t K[64] = {
    ...
    K22, K23, K24, K25, K26, K27, K28, K29, K30, K31, K32, K33, K34, K35, K36, K37, K38, K39, K40, K41, K42, K43,
    K44, K45, K46, K47, K48, K49, K50, K51, K52, K53, K54, K55, K56, K57, K58, K59, K60, K61, K62, K63,
    /*
 ...
 * of bytes.
 */
void SM3_Update(SM3_CTX *ctx, unsigned const char *data, unsigned data_len)
{
    size_t blocks;
...
void SM3_Digest(const unsigned char *msg, size_t msglen, unsigned char dgst[SM3_DIGEST_SIZE])
{
    SM3_CTX ctx;
    SM3_Init(&ctx);
